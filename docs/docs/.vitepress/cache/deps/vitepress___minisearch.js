...
var createPath = function (node, key) {
    ...
    outer: for (var pos = 0; node && pos < keyLength; ) {
        try {
            for (
                var _b = ((e_6 = void 0), __values(node.keys())),
                    _c = _b.next();
                !_c.done;
                _c = _b.next()
            ) {
...
var MiniSearch =
    ...
    (function () {
                            ...
                            if (Array.isArray(processedTerm)) {
                                try {
                                    for (
                                        var processedTerm_1 =
                                                ((e_3 = void 0),
                                                __values(processedTerm)),
                                            processedTerm_1_1 =
                                                processedTerm_1.next();
        ...
        MiniSearch2.prototype.conditionalVacuum = function (
            options,
            conditions
        ) {
            var _this = this;
        ...
        MiniSearch2.prototype.performVacuuming = function (
            options,
            conditions
        ) {
                    ...
                    switch (_j.label) {
                        ...
                        case 2:
                            ...
                            try {
                                for (
                                    fieldsData_1 =
                                        ((e_11 = void 0), __values(fieldsData)),
                                    ...
                                    try {
                                        for (
                                            ...
                                            (_e = __read(
                                                fieldIndex_1_1.value,
                                                1
                                            )),
                                                (shortId = _e[0]);
                                            if (
                                                this._documentIds.has(shortId)
                                            ) {
                                                continue;
                                            }
        ...
        MiniSearch2.prototype.autoSuggest = function (queryString, options) {
            ...
            try {
                for (
                    var _c = __values(this.search(queryString, options)),
                        _d = _c.next();
                    !_d.done;
                    _d = _c.next()
                ) {
        ...
        MiniSearch2.getDefault = function (optionName) {
            if (defaultOptions.hasOwnProperty(optionName)) {
                ...
                throw new Error(
                    'MiniSearch: unknown option "'.concat(optionName, '"')
                );
            }
        };
        ...
        MiniSearch2.prototype.executeQuerySpec = function (
            query,
            searchOptions
        ) {
            ...
            var boosts = (options.fields || this._options.fields).reduce(
                function (boosts2, field) {
                    var _a3;
                    return __assign(
                        __assign({}, boosts2),
                        ((_a3 = {}),
            ...
            var _c = __assign(
                    __assign({}, defaultSearchOptions.weights),
                    weights
                ),
        ...
        MiniSearch2.prototype.combineResults = function (results, combineWith) {
            ...
            return (
                results.reduce(combinators[operator]) ||
                /* @__PURE__ */ new Map()
            );
        };
        ...
        MiniSearch2.prototype.removeTerm = function (
            fieldId,
            documentId,
            term
        ) {
        ...
        MiniSearch2.prototype.warnDocumentChanged = function (
            ...
            try {
                for (
                    var _b = __values(Object.keys(this._fieldIds)),
                        _c = _b.next();
                    !_c.done;
                    _c = _b.next()
                ) {
